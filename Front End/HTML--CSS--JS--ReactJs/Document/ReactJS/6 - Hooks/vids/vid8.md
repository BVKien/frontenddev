...
//         setShowGoToTop(true);
//         // không re-render
//         // khi === có giá trị = nhau -> không re-render
//       } else {
...
//     // Cleanup function
//     // Mục đích: Dọn dẹp bộ nhớ khi unmounted component
//     // tránh xảy ra memory leak
//     return () => {
...
const Content = () => {
  ...
  useEffect(() => {
    ...
    // Cleanup
    // - Hàm return trong component
    // - Gọi trước component unmounted
    return () => {
